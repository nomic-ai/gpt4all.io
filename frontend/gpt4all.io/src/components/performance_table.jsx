...
const data = {
    "Model": ["GPT4All-J 6B v1.0", "GPT4All-J v1.1-breezy", "GPT4All-J v1.2-jazzy", "GPT4All-J v1.3-groovy", "GPT4All-J Lora 6B", "GPT4All LLaMa Lora 7B", "GPT4All 13B snoozy", "GPT4All Falcon", "Nous-Hermes","Dolly 6B", "Dolly 12B", "Alpaca 7B", "Alpaca Lora 7B", "GPT-J 6.7B", "LLama 7B", "LLama 13B", "Pythia 6.7B", "Pythia 12B", "Fastchat T5", "Fastchat Vicu\u00f1a 7B", "Fastchat Vicu\u00f1a 13B", "StableVicu\u00f1a RLHF", "StableLM Tuned", "StableLM Base", "Koala 13B", "Open Assistant Pythia 12B", "Mosaic MPT7B", "Mosaic mpt-instruct", "Mosaic mpt-chat", "Wizard 7B", "Wizard 7B Uncensored", "Wizard 13B Uncensored", "GPT4-x-Vicuna-13b", "Falcon 7b", "Falcon 7b instruct", "text-davinci-003"],
    "BoolQ": [73.4, 74.0, 74.8, 73.6, 68.6, 73.1, 83.3, 77.6, 79.5, 68.8, 56.7, 73.9, 74.3, 65.4, 73.1, 68.5, 63.5, 67.7, 81.5, 76.6, 81.5, 82.3, 62.5, 60.1, 76.5, 67.9, 74.8, 74.3, 77.1, 78.4, 77.7, 78.4, 81.3, 73.6, 70.9, 88.1],
    "PIQA": [74.8, 75.1, 74.9, 74.3, 75.8, 77.6, 79.2, 79.8, 78.9, 77.3, 75.4, 77.2, 79.3, 76.2, 77.4, 79.1, 76.3, 76.6, 64.6, 77.2, 76.8, 78.6, 71.2, 67.4, 77.9, 78.0, 79.3, 80.4, 78.2, 77.2, 74.2, 75.5, 75.0, 80.7, 78.6, 83.8],
